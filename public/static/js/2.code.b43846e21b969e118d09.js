...
/***/ function(module, exports, __webpack_require__) {
	...
	var Code = exports.Code = function Code(props) {return (
	    _react2.default.createElement('div', { className: 'code-container' },
	      ...
	      _react2.default.createElement('h4', null,
	        _react2.default.createElement('a', { href: 'https://jsbin.com/locofiv/1/edit?html,js,output' }, 'Black and Red Tree (ES6 classes)')),
	      ...
	      _react2.default.createElement('p', { className: 'desc' }, 'Visualized General Tree with depth-first search, add, delete node(s)'),
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".code-container{display:-ms-flexbox;display:flex;-ms-flex-direction:column;flex-direction:column;text-align:left;-ms-flex-pack:center;justify-content:center;margin:0 16%;font-family:Source Sans Pro,Helvetica Neue,Arial,sans-serif;font-size:18px}.code-container .page-desc{padding:20px auto}.code-container .desc{margin-bottom:20px;padding-left:50px}.code-container a{color:#3ca9d1}", "", {"version":3,"sources":["/./src/routes/Code/components/src/routes/Code/components/Code.scss"],"names":[],"mappings":"AAAA,gBACE,oBAAA,aAAa,0BACb,sBAAsB,gBACN,qBAChB,uBAAuB,aAEV,4DACsD,cACpD,CARjB,2BAWI,iBAAkB,CAXtB,sBAcI,mBAAmB,iBACD,CAftB,kBAkBI,aAAc,CACf","file":"Code.scss","sourcesContent":[".code-container {\n  display: flex;\n  flex-direction: column;\n  text-align: left;\n  justify-content: center;\n  //padding: 0 60px;\n  margin: 0 16%;\n  font-family: 'Source Sans Pro', 'Helvetica Neue', Arial, sans-serif;\n  font-size: 18px;\n\n  .page-desc {\n    padding: 20px auto;\n  }\n  .desc {\n    margin-bottom: 20px;\n    padding-left: 50px;\n  }\n  a {\n    color: #3CA9D1;\n  }\n}\n"],"sourceRoot":"webpack://"}]);
...
//# sourceMappingURL=2.code.b43846e21b969e118d09.js.map